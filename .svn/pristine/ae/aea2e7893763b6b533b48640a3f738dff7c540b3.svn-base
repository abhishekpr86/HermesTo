...
public interface PreOnbEmployeeDAO {
	...
	public boolean checkCorpIdExists(String corpId,String empId,String empType, String pageType);  // Check Preonb and onb tables
	
	public boolean checkEmployeeEmailExists(String email,String empId,String empType);// Check Preonb and onb tables
	...
	//Mohini added end	
		...
		List<PreOnbEmployee> searchPreOnbEmployees(PreOnbEmployee emp);
		List<Employee> listBuddy();
		public Employee getPreOnbEmployees(String corpId);
		public List<Employee> listBuddyEmp();
		
		public List<PreOnbEmployee> searchPreOnbEmpReport(PreOnbEmployee emp, Integer limit);//new method
}
