...
<body>
		...
		<nav class="pull-right">
			<ul class="nav-new">
				...
				<c:if test="${(checkUserType eq 'BundleEM')}"><!-- EM -->
					<li class="active"><a href="${pageContext.request.contextPath}/allResourceList" title="Edit List">View Resources</a></li>
			    </c:if>
	...
	<br/>
		...
		<c:url var="searchAction" value="/empSearchCriteria" ></c:url>
        ...
        <div class="formRow">
             ...
             <div class="formRow">
            <div class="col50per">
                    <div class="fieldLbl"><label>PSA ID :</label></div>
                    <div class="inputField">
                        <form:input path="psaId" id="txtPsaId" class="input-control"/>
                	</div>
                </div>
            </div>
		...
		<table id="summaryTbl" class="summary-view-table dt-responsive">
			<thead>
				<tr>
					...
					<th width="50">Billing Start Date(YYYY-MM-DD)</th>
			...
			<thead>
				...
				<c:forEach items="${employeeList}" var="employee">
					<tr>
					    <td><a href="<c:url value='/employee/${employee.id}/searchEmployeePage' />"
