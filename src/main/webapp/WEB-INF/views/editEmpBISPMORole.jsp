			...
			<form:form action="${editAction}" modelAttribute="employee" 
				...
				<div class="formRow" >
					<div class="col50per" id="internalToPSA" style="display:none;">
						...
						<div class="inputField">
							${employee.cgEntity}
							<form:hidden path="cgEntity" id="drpCgEntity" />
						</div>
					</div>
				</div>
				...
				<h1 style="color:#86A5F7">Project Information:</h1>
					...
					<div class="col50per">
						...
						<div class="inputField">
							...
							<form:hidden path="bundleEM" id="drpbundleEM"  disabled="true" />
						</div>
					  ...
					  <div class="formRow" >
						...
						<div class="inputField">
							<form:input path="joiningDate" id="txtJoiningDate" 
								...
								data-validation-help="Please enter date in dd/mm/yyyy format" disabled="true"/>
						</div>
					</div>
			...
			$('#drpbis').change(
					...
					function() {
						$.getJSON(
							...
							$("#drpSecondaryTechnology").val('${employee.secondaryTechnology.technologyId}');//mehens-new
