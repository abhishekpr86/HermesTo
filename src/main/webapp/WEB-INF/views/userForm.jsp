...
<body>
	...
	<section class="main-content">
		...
		<div class="formFields clearfix">
			...
			<c:url var="checkUserExists" value="/checkUserExists" />
					...
					<div class="col50per">
						...
						<div class="inputField">
							<form:password path="userPassword" id="password"
								class="input-control" data-validation="required" />
								<p><font color="red">(If you are not entering anything the default password will be 'pass')</font></p>
						</div>
					</div>
				</div>
					...
					<div class="col50per">
						...
						<div class="inputField">
							<form:select path="role_id" id="drproleId" class="select-control"
								...
								<form:select path="role_id" id="drproleId" multiple="multiple" class="multiselect col-md-4"
								data-validation="required">
											...
											function() {
												$
														.getJSON(
																...
																function(data) {
																	if (data == true) {
																		alert("User Name already exists . Please try another one . ");
																		$(
																				'#txtuserName')
																				.val(
																						"");
