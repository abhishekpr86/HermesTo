...
<body>
	...
	<br/>
		...
		<c:url var="searchAction" value="/orphanMgr/searchMgr" ></c:url>
        ...
        <div class="formRow">
               <div class="col50per">
					...
					<div class="col50per">
						...
						<form:radiobutton path="resourceStatus" value="Manager" id="rdManager" name="rdoGroup" class="input-control" checked = "false" />
							<label>Manager</label>
					
						<form:radiobutton path="resourceStatus" value="EM" id="rdEM" name="rdoGroup" class="input-control"/>
							<label>EM</label>
					
						<form:radiobutton path="resourceStatus" value="BundleEM" id="rdBEM" name="rdoGroup" class="input-control"/>
							<label>Bundle EM</label>
					
						<form:radiobutton path="resourceStatus" value="OffShoreEM" id="rdOffEM" name="rdoGroup" class="input-control"  />
							<label>OffShore EM</label>
