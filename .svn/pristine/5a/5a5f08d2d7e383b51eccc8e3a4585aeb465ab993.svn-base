		...
		<div class="formFields clearfix" id="mainDIV" >
			...
			<form:form action="${editAction}" commandName="employee"
				...
				<div class="formRow">
					<div class="col50per">
						<div>
							<div class="fieldLbl" id="empType" style="display: none;">
				 ...
				 <div class="formRow" id="internalToPSA" style="display:none;">
					<div class="col50per">
							<div class="fieldLbl">
								<label>PSA ID :
								</label>
							...
							<div class="inputField">
							${employee.psaId}
								<form:hidden id="txtPSAIDExt" path="psaId" />
							<%-- <form:input path="psaId" size="8" id="txtPSAIDExt" readonly="true"
							class="input-control" /> --%>
					...
					<div class="col50per">
						...
						<div class="inputField" >
							<form:select path="heritageType" id="drpType"
								class="select-control" data-validation="required" style="width: 168px;">
		...
		<div class="col50per" id="divphase" style="display: none;">
						...
						<div class="inputField">
							<form:select path="phase" id="drpphase" class="select-control"
								data-validation="required"  style="width: 168px;">
				...
				<div class="formRow">
					<div class="col50per">
						...
						<div class="inputField">
							<form:select path="entity" id="drpEntity" style="width: 168px; white-space: nowrap; text-overflow: ellipsis;"
				...
				<%-- <div class="formRow">
					...
					<div class="col50per" id="txtshadowStartDate" style="display: none;">
						...
						<div class="inputField">
							<form:input path="shadowStartDate" id="shadowStartDate"
								class="input-control" 
								data-validation-help="Please enter date in dd/mm/yyyy format" />
						</div>
					</div>
				...
				<div class="col50per">
						...
						<div class="inputField">
							<form:select path="bis" id="drpbis"
								class="select-control"  style="width: 168px;">
					...
					<div class="col50per">
						<div>
							...
							<div class="fieldLbl" id="empID" style="display: block;">
								<label>PC Hostname <span class="req" >*</span>:
								</label>
							</div>
							
							<div class="inputField">
							<form:input path="pcSerialNumber" id="pcDetailsID" class="input-control" data-validation="required" 
							data-validation-help="Please enter value"
							style="width: 168px;"/>
							</div>
						</div>
					</div>
				<%-- 	<div class="col50per" id="divCorpId" style="display: block;">
						<div class="fieldLbl">
							<label id="corpID">MAC Address <span class="req">*</span>:
							</label>
							
						</div>
						<div class="inputField">
		
							<form:input path="macAddress" id="macAddressID" class="input-control" data-validation="required"  style="width: 168px;"/>
						</div>
					</div> --%>
				</div>
